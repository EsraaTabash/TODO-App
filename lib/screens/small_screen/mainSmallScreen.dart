...
class MainSmallScreen extends StatefulWidget {
  @override
  State<MainSmallScreen> createState() => _MainSmallScreenState();
}

class _MainSmallScreenState extends State<MainSmallScreen> {
